        ...
        <>
            <div className="calculator">
                ...
                <div className="calculator__keys">
                    <button className="calculator_key calculator_key--operator" value="+" onClick={()=>{HandleButtonClick('+')}}>+</button>
                    <button className="calculator_key calculator_key--operator" value="-" onClick={()=>{HandleButtonClick('-')}}>-</button>
                    <button className="calculator_key calculator_key--operator" value="*" onClick={()=>{HandleButtonClick('*')}}>&times;</button>
                    <button className="calculator_key calculator_key--operator" value="/" onClick={()=>{HandleButtonClick('/')}}>÷</button>
